...
// See https://github.com/chipsalliance/rocket-chip/blob/master/LICENSE.SiFive for license details.
...
object CRC
{
  ...
  val CRC_8F_6 = BigInt(0x137) // https://users.ece.cmu.edu/~koopman/crc/hd6.html
}
